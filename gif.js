(function () {
 ...
 //==================			
    ...
    var html = '<union id="{UNION_ID}" style="height: auto;width: 100%; display:block; overflow: hidden; position: relative; top:0; left:0;">\
                    ...
                    <img src="{NODE_IMG}" alt="ͼƬ" data-type="note" style="position: absolute; right:10px; bottom:60px;width: 200px;height: auto;"/>\
                    </union>';
